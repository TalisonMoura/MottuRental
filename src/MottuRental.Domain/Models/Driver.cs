...
public class Driver(string name, string cnpj, DateTime birthDate, CnhType cnhType, string numeroCNH) : Entity
{
    ...
    public void SetImageName(string path) => ImagemCNH = path;
}